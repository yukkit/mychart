...
ldb.worker.stream.extLibs={{ .Values.stream.streamWorker.libPath }}
ldb.worker.stream.kafkaLib={{ .Values.stream.streamWorker.kafkaLibPath }}
ldb.server.kerberos.krb5.conf=/etc/hadoop/conf/krb5.conf
ldb.worker.stream.extra.jdbc.lib={{ .Values.stream.streamWorker.libPath }}
