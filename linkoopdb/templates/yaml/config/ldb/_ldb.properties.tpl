...
ldb.worker.stream.extLibs={{ .Values.nfs.mountPath | default "/fsshare"  }}/{{ .Values.nfs.extLibPath | default "extlib" }}
ldb.worker.stream.kafkaLib={{ .Values.nfs.mountPath | default "/fsshare"  }}/{{ .Values.nfs.kafkaLibPath | default "kafka" }}
ldb.server.kerberos.krb5.conf=/etc/hadoop/conf/krb5.conf
ldb.worker.stream.extra.jdbc.lib={{ .Values.nfs.mountPath | default "/fsshare"  }}/{{ .Values.nfs.libPath | default "lib" }}
